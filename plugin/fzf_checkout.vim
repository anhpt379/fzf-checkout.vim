...
execute 'command! -bang -nargs=0 ' . s:branch_command . ' silent! call fzf_checkout#list(<bang>0, "branch")'
execute 'command! -bang -nargs=0 ' . s:tag_command . ' silent! call fzf_checkout#list(<bang>0, "tag")'
